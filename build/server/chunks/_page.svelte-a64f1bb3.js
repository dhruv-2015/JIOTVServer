import { c as create_ssr_component, a as subscribe, b as add_attribute, d as each, v as validate_component } from './index2-b63c4e3b.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="container"><div class="mb-2 ml-1">
            <input type="search" id="search" class="relative w-[30%] col-span-4 block mx-4 rounded-l border border-solid border-neutral-300 bg-transparent bg-clip-padding px-3 py-1.5 text-base font-normal text-neutral-700 outline-none transition duration-300 ease-in-out focus:border-primary focus:text-neutral-700 focus:shadow-te-primary focus:outline-none dark:text-neutral-200 dark:placeholder:text-neutral-700" placeholder="Search"${add_attribute("value", $searchStore.search, 0)}>
            </div>
...
//# sourceMappingURL=_page.svelte-a64f1bb3.js.map
